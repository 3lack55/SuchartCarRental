...
export default function Login() {
    ...
    return (
        <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2" style={{ minHeight: '100vh', background: 'var(--page-bg, #F4EBDC)' }}>
            ...
            <aside className="hidden lg:flex flex-col justify-between px-14 py-12 relative overflow-hidden" style={{ background: themeMode === 'dark' ? 'rgba(var(--primary-color-rgb), 0.7)' : 'var(--primary-color, #4A3524)', color: 'var(--on-primary, #EDEFE9)', transition: 'background 0.3s ease' }}>
            ...
            <main className="flex items-center justify-center px-6 py-12">
                <div className="w-full max-w-sm">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            <label htmlFor="username" className="block text-[13px] font-semibold mb-1.5">ชื่อผู้ใช้</label>
                            <div
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-1.5">
                                <label htmlFor="pw" className="block text-[13px] font-semibold">รหัสผ่าน</label>
                            </div>
                            <div
